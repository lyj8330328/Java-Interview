...
下图是jdk1.8之前的hashmap结构，左边部分即代表哈希表，也称为哈希数组，数组的每个元素都是一个单链表的头节点，链表是用来解决冲突的，如果不同的key映射到了数组的同一位置处，就将其放入单链表中。z

![JDK1.8之前HashMap结构图](F:\images/201818241335-v.png)
...
![JDK1.8 HashMap结构图](F:\images/201818241341-L.png)

![](F:\images/201818241342-d.png)

上图很形象的展示了HashMap的数据结构（数组+链表+红黑树），桶中的结构可能是链表，也可能是红黑树，红黑树的引入是为了提高效率。 

![](F:\images/201818241409-c.png)

##### 2.1 链表的实现

![](F:\images/201818241416-1.png)
...
![](F:\images/201818261719-v.png)

##### 2.3 位桶

![](F:\images/201818261721-O.png)
...
![](F:\images/201818262038-O.png)

<3>**HashMap()**

![](F:\images/201818262039-T.png)

<4>**HashMap(Map<? extends K, ? extends V> m)**

![](F:\images/201818262040-s.png)
...
![1545828744891](F:\images/201818262052-C.png)
...
![](F:\images/201818262127-P.png)

putVal方法执行过程可以通过下图来理解： 

![](F:\images/201818262216-D.png)
